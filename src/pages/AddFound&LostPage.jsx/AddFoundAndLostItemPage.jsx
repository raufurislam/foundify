...
//     // Add the date from the state to the object
//     formDataObject.date = date.toISOString(); // Use ISO string for consistent format
...
//         } else {
//           // Show error alert if `insertedId` is not available
//           Swal.fire({
//             position: "top-center",
//             icon: "error",
...
//               className="w-full border rounded-lg px-3 py-2"
//               required
//               defaultValue="" // Ensures placeholder shows by default
//             >
//               <option value="" disabled>
//                 Select Category
//               </option>
...
//               <option value="Clothing">Clothing</option> {/* New Category */}
//               <option value="Jewelry">Jewelry</option> {/* New Category */}
