...
//   return (
//     <div className="rounded-xl pb-5 group shadow-lg bg-base-200 flex flex-col h-full">
//       {/* Thumbnail */}
//       <img
//         src={thumbnail}
//         alt={title}
//         className="w-full group-hover:scale-105 h-52 object-cover rounded-t-xl mb-4"
//       />
...
const ItemCard = ({ item }) => {
  ...
  return (
    <div className="rounded-xl pb-5 group shadow-lg bg-base-200 flex flex-col h-full overflow-hidden">
      {/* Thumbnail */}
      ...
      <div className="px-4 flex flex-col flex-grow mt-3">
        {/* Title */}
        <div className="flex justify-between items-center">
          <h2 className="font-bold mb-2">{title}</h2>
          <button
